        ...
        <CardDeck className='mb-4'>
          <Card bg={ theme }>
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                The front-end is ReactJS and bootstrapped by Create-React-App while the back-end is Express
          ...
          <Card bg={ theme }>
            ...
            <Card.Body>
              ...
              <Card.Text>
                As the Team Lead of a group of 6, we developed a First Person Shooter using Unity 2019.4.18LTS
                and using Unity Collaborate for version control. This project was written in C# during Spring 2020
                for Multiplayer Game Development at San Francisco State University.
                <footer>
          ...
          <Card bg={ theme }>
            ...
            <Card.Body>
              ...
              <Card.Text>
                As a team of six we built a web app that was designed to help groups of people that were
                living together maintain houshold chores. Our stack was: ReactJS for the front-end,
                Express for the back-end, and MongoDB for the database.
                <footer>
                  <small className="text-muted">
                    Read the Final Report on GitHub for more info.
                  </small>
                </footer>
              </Card.Text>
